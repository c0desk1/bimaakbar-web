...
export default function LoginPage() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen px-4">
      <div className="bg-[var(--card)] p-8 rounded-[var(--radius)] shadow-md max-w-sm w-full text-center">
        ...
        <button
          ...
          className="inline-flex items-center justify-center gap-2 px-4 py-2 bg-[var(--accent)] text-[var(--foreground)] rounded hover:bg-[var(--accent)]/90 transition"
        >
          <svg
