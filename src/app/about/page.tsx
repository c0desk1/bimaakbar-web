    ...
    return (
      <section className="relative mt-14 mb-14">
        ...
        <div className="flex flex-col md:flex-row h-auto gap-14">
          {data.coverImage && (
            <div>
              <Image
                ...
                width={120}
                height={120}
                sizes="(max-width: 640px) 100vw, (max-width: 1024px) 80vw, 300px"
                priority
                fetchPriority="high"
          ...
          <div>
            <h1 className="text-3xl md:text-5xl font-bold tracking-tighter leading-tight md:leading-none text-center md:text-left">
              {data.title}
            </h1>
