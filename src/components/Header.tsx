...
const Header: React.FC = () => {
  ...
  return (
    <header className={`fixed top-0 z-50 w-full h-16 ${isScrolled ? 'bg-[var(--color-bg)] backdrop-blur-md border-b border-[var(--color-border)]' : 'bg-transparent border-b border-transparent'}`}>
      <Container size="xl">
        <div className="py-4">
