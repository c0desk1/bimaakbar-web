...
export default function Card({ entry, pill }: Props) {
  return (
    <a href={`/${entry.collection}/${entry.slug}`} className="group flex flex-row justify-between h-full items-center text-left p-4 gap-2 border rounded-xl bg-[var(--color-card-bg)] hover:bg-[var(--color-hover)] border-[var(--color-border)]">
