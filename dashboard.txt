const firebaseConfig = {
        ...
        function initPostListSection() {
            ...
            if (allPostsTableBody) {
                ...
                allPostsTableBody.innerHTML = `<tr><td colspan="6" style="text-align: center; color: #8E8E93;">Memuat daftar postingan...</td></tr>`;
                ...
                registerListener('postListSection', 'posts', 'value', (snapshot) => {
                    ...
                    if (posts) {
                        ...
                        if (postsArray.length > 0) {
                            ...
                            allPostsTableBody.innerHTML = `<tr><td colspan="6" style="text-align: center; color: #8E8E93">Belum ada postingan.</td></tr>`;
